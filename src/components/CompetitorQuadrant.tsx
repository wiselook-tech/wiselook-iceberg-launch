        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            ...
            >
              ...
              <rect x={margin + chartWidth/2} y={margin} width={chartWidth/2} height={chartHeight/2} fill="#f0f9ff" opacity="0.2" />
              <rect x={margin} y={margin + chartHeight/2} width={chartWidth/2} height={chartHeight/2} fill="#fef3c7" opacity="0.2" />
              <rect x={margin + chartWidth/2} y={margin + chartHeight/2} width={chartWidth/2} height={chartHeight/2} fill="#ecfdf5" opacity="0.2" />

    ...
    <div className="container mx-auto px-6">
      <div className="max-w-6xl mx-auto space-y-12">
        <div className="text-center space-y-4">
          <h2 className="font-heading font-bold text-3xl md:text-4xl text-foreground">About Us</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="bg-background rounded-xl p-8 shadow-card flex flex-col h-full">
            <div className="text-center space-y-6 flex flex-col h-full">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed flex-grow min-h-[8rem] text-center">
                Applied scientist and product leader. Former Founder of Epoch Metrics and Lead Data Scientist at Clarity
                AI. Holds a PhD in Mathematical Engineering and completed postdoctoral research at MIT. Specializing in
                AI and data-driven product development, he is recognized for integrating advanced technology and science
                with business strategy to empower organizations and unlock human potential.
              </p>
          ...
          <div className="bg-background rounded-xl p-8 shadow-card flex flex-col h-full">
            <div className="text-center space-y-6 flex flex-col h-full">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed flex-grow min-h-[8rem] text-center">
                Entrepreneur and executive leader in customer experience, business design, and organizational
                intelligence. CXO at Restaurant Brands Iberia, business connector at Klarna, and former startup founder;
                expert in leading strategic digital transformation and acclaimed for her innovative approaches to talent
          ...
          <div className="bg-background rounded-xl p-8 shadow-card flex flex-col h-full">
            <div className="text-center space-y-6 flex flex-col h-full">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed flex-grow min-h-[8rem] text-center">
                Multidisciplinary leader with over 25 years of experience in investment banking, entrepreneurship, and
                motorsports. CEO and Partner at Talengo, advisor and coach, former Goldman Sachs executive, and author;
                highly regarded for his expertise in leadership development, talent strategy, and organizational

    ...
    <div className="container mx-auto px-6">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      <strong>Data minimization</strong>, user consent management, transparency, and compliance with{" "}
              ...
              <div className="bg-background rounded-xl p-6 shadow-card">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Your data is <strong>never used to train AI models</strong>—contractually enforced and technically
                      protected on every step of the process.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-background rounded-xl p-6 shadow-card">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      LLM inference occurs within the <strong>EU for EU clients</strong> and follows data sovereignty
                      compliance for clients based in the Americas.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-background rounded-xl p-6 shadow-card">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      <strong>Environment isolation</strong>, <strong>end-to-end encryption</strong> at rest and in
                      transit, continuous vulnerability monitoring, and proactive threat detection.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-background rounded-xl p-6 shadow-card">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      <strong>Role-based access</strong>, behavioral analysis, and a comprehensive, immutable audit
                      trail capturing all user actions and AI interactions.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-background rounded-xl p-6 shadow-card">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Defenses against <strong>prompt injection</strong>, prompt tampering, and output filtering prevent
                      model misuse or leakage of sensitive info.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-6">
            <h3 className="font-heading font-bold text-xl text-foreground text-center lg:text-left">AI Governance</h3>
              ...
              <div className="bg-background rounded-xl p-6 shadow-card">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      AI monitoring with <strong>full input/output logging</strong>, continuous response evaluations, and
                      prompt versioning for secure, controlled AI interactions.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-background rounded-xl p-6 shadow-card">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      AI management aligned with <strong>responsible AI principles</strong>, ensuring critical HR
                      decisions require mandatory human validation and oversight.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-background rounded-xl p-6 shadow-card">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      <strong>Transparent reasoning</strong>, source references, and confidence scoring accompany every

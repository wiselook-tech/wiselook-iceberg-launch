...
const HeroSection = () => {
  return (
    <section id="home" className="relative overflow-hidden pt-[70px]">
      <div className="max-w-6xl container mx-auto pb-32 md:pb-40 ">
        <div className="relative grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="z-10 pt-48 space-y-8">
            <motion.h1
              className="relative font-heading font-bold text-4xl md:text-5xl lg:text-6xl leading-tight text-foreground"
            ...
            <motion.p
              className="relative text-lg md:text-xl text-muted-foreground max-w-xl"
              initial={{ left: -150, opacity: 0 }}
              animate={{ left: 0, opacity: 1 }}
            ...
            <motion.div
              className="relative pt-4 flex flex-col gap-4"
      ...
      <motion.div
        className="absolute w-2/3 -right-12"
        initial={{ top: 400, opacity: 0 }}
        animate={{ top: 68, opacity: 1 }}
      ...
      >
        <motion.img
          ...
          animate={{
            filter: "hue-rotate(350deg) brightness(100%) saturate(0%)",
          }}
